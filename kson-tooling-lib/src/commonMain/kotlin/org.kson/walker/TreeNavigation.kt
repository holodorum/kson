 ...
 * [org.kson.value.navigation.KsonValueNavigation] but are parameterized by the
 * walker, enabling the same logic to operate on different tree representations
 * (e.g. [org.kson.value.KsonValue] trees and IntelliJ PSI trees).
 */
