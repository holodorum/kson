...
class AstNodeWalkerTest {
    ...
    fun testGetArrayElements() {
        ...
        assertTrue(elements.all { it is StringNodeImpl })
    }
    ...
    // --- Quoted property keys use processedStringContent ---
    ...
    // --- Error node handling ---
    //
    // In delimited syntax, missing values produce ObjectPropertyNodeError
    // nodes. The walker skips these (the as? ObjectPropertyNodeImpl cast
    // fails), but valid sibling properties remain accessible.
