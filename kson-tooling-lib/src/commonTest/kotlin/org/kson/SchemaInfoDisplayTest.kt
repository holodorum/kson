...
class SchemaInfoDisplayTest {
    ...
    fun testGetSchemaHoverInfoEndToEnd() {
        ...
        val hoverInfo = KsonTooling.getSchemaInfoAtLocation(KsonTooling.parse(document), schema, 2, 15)
        assertNotNull(hoverInfo)
    ...
    fun testGetSchemaHoverInfoForNestedArrayElement() {
        ...
        val hoverInfo = KsonTooling.getSchemaInfoAtLocation(KsonTooling.parse(document), schema, 2, 17)
        assertNotNull(hoverInfo)
        assertTrue(hoverInfo.contains("**User Name**"))
