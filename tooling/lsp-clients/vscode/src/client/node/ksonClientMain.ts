...
import { initializeLanguageConfiguration, isKsonDialect } from '../../config/languageConfig';
...
export async function activate(context: vscode.ExtensionContext) {
    // Initialize language configuration cache
    initializeLanguageConfiguration(context.extensionPath);
