...
// CLI Customization — read from gradle.properties, overridable with -P flags
...
// Task to generate Version.kt and CustomizationsConfig.kt
val generatedSrcDir = layout.buildDirectory.dir("generated/kotlin")
val generateConstants by tasks.registering {
    group = "build"
    description = "Generates Version.kt and CustomizationsConfig.kt"
    ...
    val customizationFile = outputDir.resolve("CustomizationsConfig.kt")

    // Get version from kson-lib project
    val ksonLibVersion = project(":kson-lib").version.toString()

    outputs.files(versionFile, customizationFile)
    ...
    doLast {
        ...
        println("Generated CustomizationsConfig.kt with CLI_NAME = $cliName")
    }
}
