...
class KsonSchemaGotoDeclarationHandler : GotoDeclarationHandler {
    ...
    override fun getGotoDeclarationTargets(
        ...
        val lineCol = lineColumnFromOffset(file.text, offset) ?: return null
        ...
        val targets = ranges.mapNotNull { range ->
            val targetOffset = offsetFromLineColumn(resolution.schemaText, range.startLine, range.startColumn) ?: return@mapNotNull null
